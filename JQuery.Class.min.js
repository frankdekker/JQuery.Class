(function(){Function.prototype.bind||(Function.prototype.bind=function(){return $.proxy.apply($,[this].concat([].slice.call(arguments)))});this.Class=function(c){c=c||{};var b=function(){for(var b in this){var a=this[b];switch($.type(a)){case "object":this[b]=$.extend(!0,{},a);break;case "array":this[b]=$.extend(!0,[],a)}}return this.initialize?this.initialize.apply(this,arguments):this};b.$definition=c;a(b.prototype,c);b.prototype.parentMethod=function(){try{if(arguments.callee.caller===this.$parent)return window.console&&
console.error("This function has no parent."),!1}catch(b){}return this.$parent.apply(this,arguments)};return b};var a=function(c,e){for(var d in e)!1!==e.hasOwnProperty(d)&&void 0!==e[d]&&("Extends"===d?$.each("array"===$.type(e.Extends)?e.Extends:[e.Extends],function(){a(c,this.$definition)}):$.isFunction(c[d])&&$.isFunction(e[d])?c[d]=b(e[d],c[d]):c[d]=e[d])},b=function(b,a){return function(){var d=this.$parent;this.$parent=a;var f=b.apply(this,arguments);this.$parent=d;return f}}})();(function(){var a=function(b){return b.replace(/^on([A-Z])/,function(b,a){return a.toLowerCase()})};this.Chain=new Class({$chains:[],chain:function(b){this.$chains.push(b);return this},callChain:function(b){if(0==this.$chains.length)return this;var a=this.$chains.shift();"function"==typeof a&&a.apply(this,arguments);return this},clearChain:function(){this.$chains=[];return this}});this.Events=new Class({$events:{},on:function(b,c){b.split(" ").forEach(function(b){b=a(b);var d=this.$events[b]||[];
0>$.inArray(d,c)&&(d.push(c),this.$events[b]=d)}.bind(this));return this},off:function(b,c){b=a(b);var e=this.$events[b];if(e)if(void 0===c)delete this.$events[b];else{var d=$.inArray(c,e);-1!==d&&delete e[d]}return this},trigger:function(b,c){var e,d;b=a(b);e=this.$events[b];if(!e)return this;c=$.isArray(c)?c:[c];for(d=0;d<e.length;d++)e[d]&&e[d].apply(this,c);return this}});this.Options=new Class({setOptions:function(){var b=this.options=$.extend.apply(null,$.merge([!0,{},this.options],arguments));
if(this.on)for(var a in b)"function"==$.type(b[a])&&/^on[A-Z]/.test(a)&&(this.on(a,b[a]),delete b[a]);return this}})})();(function(){this.Drag=new Class({Extends:[Events,Options],element:null,options:{snap:10,preventDefault:!1,stopPropagation:!1},bound:{},mouse:{},initialize:function(a,b){this.element=a;this.setOptions(b);this.bound={start:$.proxy(this.start,this),check:$.proxy(this.check,this),drag:$.proxy(this.drag,this),cancel:$.proxy(this.cancel,this),stop:$.proxy(this.stop,this)};this.attach()},attach:function(){this.element.on("touchstart mousedown",this.bound.start);return this},detach:function(){this.element.off("touchstart mousedown",
this.bound.start);return this},start:function(a){var b="mousedown"===a.type,c="touchstart"===a.type;(!0===this.options.preventDefault||b&&"mouse"===this.options.preventDefault||c&&"touch"===this.options.preventDefault)&&a.preventDefault();(!0===this.options.stopPropagation||b&&"mouse"===this.options.stopPropagation||c&&"touch"===this.options.stopPropagation)&&a.stopPropagation();b=this.getPoint(a);this.mouse.start=b;this.trigger("beforeStart",[this.element,b,a]);$(document).on("mousemove touchmove",
